...
Preliminary evidence from the United States supports this framework. Using individual-level data from the Cooperative Election Study and county-level election returns, we find that voters who experienced personal economic costs---particularly job loss and bereavement---were significantly more likely to defect from the incumbent, and this effect is concentrated among the incumbent's prior supporters. A shift-share instrumental variables analysis confirms the causal interpretation. This paper extends that finding to a comparative framework integrating network methods with causal inference.
